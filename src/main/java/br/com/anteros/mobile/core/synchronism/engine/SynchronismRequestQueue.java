...
public class SynchronismRequestQueue implements Serializable{
	...
	public void addRequest(MobileRequest mobileRequest) {
		queue.add(mobileRequest);
	}
	...
	public void clearQueueUserAgent(String application, String userAgent) {
		while (true) {
			MobileRequest mobileRequest = this.getRequest(application, userAgent);
